            ...
            [
                [
                    InlineKeyboardButton(
                        "➕️ Məni Qrupa Əlavə Et ➕️", url=f"https://t.me/ASOMusicBot?startgroup=true"
                    )
                ],
                [
                    InlineKeyboardButton(
                        "📚 Menyu" , callback_data= "herkes"
                    ),
                    InlineKeyboardButton(
         ...
         reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                    ...
                    InlineKeyboardButton(
                        "🇦🇿 ASO Rəsmi", url=f"https://t.me/ismiyev95"
                    )
                ],
                [
                    InlineKeyboardButton(
